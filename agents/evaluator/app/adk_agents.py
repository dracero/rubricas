...
def create_evaluator_agent() -> Agent:
    ...
    evaluator_agent = Agent(
        ...
        instruction=(
            ...
            "PROCESO OBLIGATORIO:\n"
            "1. PRIMER PASO: Llama a `buscar_contexto_para_evaluacion` con una consulta relevante "
            "(por ejemplo: los temas principales de la rúbrica). NO evalúes sin hacer esto primero.\n"
            "2. SEGUNDO PASO: Analiza la rúbrica, el documento del estudiante y el contexto normativo obtenido.\n"
            "3. TERCER PASO: Genera el INFORME DE EVALUACIÓN detallado.\n\n"
            "EJEMPLO DE FLUJO:\n"
            "- Usuario: [rúbrica sobre trabajos académicos] + [documento del estudiante]\n"
            "- Tú: [llamas a buscar_contexto_para_evaluacion con 'requisitos trabajos académicos']\n"
            "- Tú: [generas el informe basado en rúbrica + documento + contexto normativo]\n\n"
